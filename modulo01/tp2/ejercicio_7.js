...
function alReves(texto) { // Se define una función llamada alReves que toma un parámetro texto.
    let invertido = Array.from(texto).reverse().join(""); // crea una nueva variable 'invertido'. Se utiliza 'Array.from(texto)' para convertir el texto en un array de caracteres. Luego se utiliza 'reverse()' para invertir el orden de los elementos. Por ultimo se usa 'join("")' para unir los elementos del array en una cadena de texto nuevamente.
